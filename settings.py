...
def parse_opts():
    ...
    parser.add_argument(
        '--ratio', default=0.80, type=float, help='The ratio of train data'
    )
    ...
    parser.add_argument(
        '--pretrain_path', default='', type=str, help='Path for pretrained model.'
    )

    parser.add_argument('--gpu_id', default=0, type=int, help='Single GPU id')
    parser.add_argument(
